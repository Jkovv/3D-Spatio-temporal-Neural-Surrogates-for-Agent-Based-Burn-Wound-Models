# combi3D/Simulation/params_biology.py
# Biophysical constants: diffusion, decay, saturation, lifespans, cell counts.
# Edit here when calibrating to new experimental data.
# Do NOT edit this file for transcriptomics integration — see params_transitions.py.
...
# Baseline counts are for the 500³ variant; scale_factor adjusts for smaller lattices.
# Floor at 1 to ensure at least one cell of each required type.
...
init_f   = _scaled(100,  "init_f")     # fibroblasts
...
# Applied last so the sampled vector can vary cell counts. Cast to int here.
