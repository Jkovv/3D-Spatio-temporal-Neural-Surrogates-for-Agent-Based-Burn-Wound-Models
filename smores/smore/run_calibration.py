...
def main():
    ...
    ap.add_argument("--params", nargs="+", default=None,
                    help="Explicit list of parameters to calibrate, overriding "
                         "--top-k. Use to compare Sobol-ranked vs identifiable "
                         "parameter sets (sensitive != identifiable).")
    ...
    if args.params:
        ...
        selection_mode = f"sobol_top_{args.top_k}"
