# combi3D/Simulation/params_grid.py
# Lattice geometry, time conversions, and mesh dimensions.
# These constants never change between simulation runs.
# Do NOT edit this file for transcriptomics integration.
