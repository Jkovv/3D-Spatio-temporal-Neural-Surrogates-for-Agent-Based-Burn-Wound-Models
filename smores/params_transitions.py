# combi3D/Simulation/params_transitions.py
# Cell-signal response parameters: production rates, sigmoid weights,
# activation thresholds, and Michaelis-Menten kinetics.
#
# *** TRANSCRIPTOMICS INTEGRATION POINT ***
# After GLASSO inference and gene-to-parameter mapping, the student should
# apply adjustments in transcriptomics_overrides.py — not directly here.
